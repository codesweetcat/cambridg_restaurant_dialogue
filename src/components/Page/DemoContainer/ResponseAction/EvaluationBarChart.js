...
const Evaluation = {
    'action_probs': [
      -0.05, -0.1, 0.1, 0.1, -0.15, 0.1, -0.7, 0.1
    ],
    agent_select: 6,
    eval_select: 1
}
...
const backgroudColorTickLabel = (task,lightBackground,darkBackground) => {
  ...
  task['action_probs'].map((item,i)=>{
    i === eval_select ? backgroudColorTickLabel.push(lightBackground) : 
...
const EvaluationBarChart = ({labels,dataset,lightBarColor,darkBarColor}) => {
...
return(
  <div class="enaluation_chart-container">
